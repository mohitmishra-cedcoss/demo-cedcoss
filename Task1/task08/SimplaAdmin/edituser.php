...
<?php
 ...
 global $conn;
 $sql="update  Users set name='$UserName',password='$Password',type='$UserType',img='$UserImage',gender='$Gender' where id=$id";
if($conn->query($sql)==TRUE)
{
   echo '<div class="notification success png_bg">
				<a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
				<div>
					Updation have been performed succesfully
				</div>
			</div>';
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>UserName</label>
										<input class="text-input small-input"  type="text" id="small-input" name="Username" value="<?php  echo $Username  ?>" />  <!-- Classes for input-notification: success, error, information, attention -->
										<br /><small>A small description of the field</small>
								</p>
								
								<p>
									<label>Password</label>
									<input class="text-input medium-input datepicker" type="text" id="ProductPrice" name="Password" value="<?php  echo $Password  ?>" /> 
								</p>
								...
								<p>
									...
									<input class="text-input large-input" type="file" id="large-input" name="large-input" /><img width="3%" height="10%" src="../uploads/<?php echo   $UserImage; ?>">
								</p>
